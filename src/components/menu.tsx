...
const Menu: React.FC<propsInterface> = (props) => {
  ...
  return (
    <div className='items'>
      ...
      <div className='title'>{txt.logIn}</div>

      <div className='title'>{txt.identity}</div>
      <div className='title'>{txt.accounts}</div>
      <div className='title'>{txt.claims}</div>
      <hr/>
      <div className='title'>{txt.profile}</div>
      <div className='title'>{txt.password}</div>
      <div className='title'>{txt.settings}</div>
      <div className='title'>{txt.logout}</div>
      <hr/>
